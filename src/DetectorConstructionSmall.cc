...
DetectorConstructionSmall::DetectorConstructionSmall():G4VUserDetectorConstruction() {}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

DetectorConstructionSmall::~DetectorConstructionSmall()
{ }

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

G4VPhysicalVolume* DetectorConstructionSmall::Construct()
{
  ConstructMaterials();
  ...
  G4double scintillatorSizeX = 10*mm;
  ...
  new G4LogicalBorderSurface("TeflonBorderSurface", physScint, physEnv, teflonSurface);

  return physWorld;
}

void DetectorConstructionSmall::ConstructMaterials() {
